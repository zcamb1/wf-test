    ...
    <script>
        ...
        async function detectVideoFPS(mainVideo, options = {}) {
            ...
            try {
                ...
                // Dọn dẹp video ẩn để giảm sử dụng bộ nhớ
                cleanupHiddenVideo();
            }
        }

        // Hàm dọn dẹp video ẩn để giải phóng bộ nhớ
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Xử lý sự kiện khi thay đổi nguồn video
            videoPlayer.addEventListener('emptied', () => {
                // Khi video bị xóa nguồn hoặc thay đổi, làm sạch badge FPS
                fpsBadge.style.display = 'none';
                cachedFPS = null;
